...
export const BADGES = [
  // Streak Badges
  {
    ...
    unlock: (stats) => stats.currentStreak && stats.currentStreak >= 3,
    progress: (stats) => (Math.min(stats.currentStreak || 0, 3) / 3) * 100,
    tier: 1,
  },
  {
    id: "streak-7",
    ...
    icon: "🔥🔥",
    category: BADGE_CATEGORIES.STREAK,
    unlock: (stats) => stats.currentStreak && stats.currentStreak >= 7,
    progress: (stats) => (Math.min(stats.currentStreak || 0, 7) / 7) * 100,
    tier: 2,
  },
  {
    id: "streak-30",
    ...
    icon: "🔥🔥🔥",
    category: BADGE_CATEGORIES.STREAK,
    unlock: (stats) => stats.currentStreak && stats.currentStreak >= 30,
    progress: (stats) => (Math.min(stats.currentStreak || 0, 30) / 30) * 100,
    tier: 3,
  },
  ...
  // Course Badges
  {
    ...
    unlock: (stats) => stats.coursesCompleted && stats.coursesCompleted >= 1,
    progress: (stats) => (stats.coursesCompleted && stats.coursesCompleted >= 1 ? 100 : 0),
    tier: 1,
  },
  {
    id: "course-5",
    ...
    icon: "🎓",
    category: BADGE_CATEGORIES.COURSE,
    unlock: (stats) => stats.coursesCompleted && stats.coursesCompleted >= 5,
    progress: (stats) => (Math.min(stats.coursesCompleted || 0, 5) / 5) * 100,
    tier: 2,
  },
  {
    id: "course-10",
    ...
    icon: "🏫",
    category: BADGE_CATEGORIES.COURSE,
    unlock: (stats) => stats.coursesCompleted && stats.coursesCompleted >= 10,
    progress: (stats) => (Math.min(stats.coursesCompleted || 0, 10) / 10) * 100,
    tier: 3,
  },
  ...
  // XP Badges
  {
    ...
    unlock: (stats) => stats.totalXp && stats.totalXp >= 100,
    progress: (stats) => (Math.min(stats.totalXp || 0, 100) / 100) * 100,
    tier: 1,
  },
  {
    id: "xp-250",
    ...
    icon: "✨",
    category: BADGE_CATEGORIES.XP,
    unlock: (stats) => stats.totalXp && stats.totalXp >= 250,
    progress: (stats) => (Math.min(stats.totalXp || 0, 250) / 250) * 100,
    tier: 1,
  },
  {
    id: "xp-500",
    ...
    icon: "✨",
    category: BADGE_CATEGORIES.XP,
    unlock: (stats) => stats.totalXp && stats.totalXp >= 500,
    progress: (stats) => (Math.min(stats.totalXp || 0, 500) / 500) * 100,
    tier: 1,
  },
  {
    id: "xp-1000",
    ...
    icon: "⭐",
    category: BADGE_CATEGORIES.XP,
    unlock: (stats) => stats.totalXp && stats.totalXp >= 1000,
    progress: (stats) => (Math.min(stats.totalXp || 0, 1000) / 1000) * 100,
    tier: 2,
  },
  {
    id: "xp-5000",
    ...
    icon: "🌟",
    category: BADGE_CATEGORIES.XP,
    unlock: (stats) => stats.totalXp && stats.totalXp >= 5000,
    progress: (stats) => (Math.min(stats.totalXp || 0, 5000) / 5000) * 100,
    tier: 3,
  },
  ...
  // Quiz Badges
  {
    ...
    unlock: (stats) => stats.perfectQuizzes && stats.perfectQuizzes >= 1,
    progress: (stats) => (stats.perfectQuizzes && stats.perfectQuizzes >= 1 ? 100 : 0),
    tier: 1,
  },
  {
    id: "quiz-master",
    ...
    icon: "🎓",
    category: BADGE_CATEGORIES.QUIZ,
    unlock: (stats) => stats.highScoreQuizzes && stats.highScoreQuizzes >= 10,
    progress: (stats) => (Math.min(stats.highScoreQuizzes || 0, 10) / 10) * 100,
    tier: 2,
  },
  ...
  // Additional Special Badges
  {
    ...
    icon: "🦉",
    category: BADGE_CATEGORIES.SPECIAL,
    unlock: (stats) => stats.nightLessons && stats.nightLessons >= 5,
    progress: (stats) => (Math.min(stats.nightLessons || 0, 5) / 5) * 100,
    tier: 1,
  },
  {
    id: "early-bird",
    ...
    icon: "🌅",
    category: BADGE_CATEGORIES.SPECIAL,
    unlock: (stats) => stats.morningLessons && stats.morningLessons >= 5,
    progress: (stats) => (Math.min(stats.morningLessons || 0, 5) / 5) * 100,
    tier: 1,
  },
  // Additional badges to add to your BADGES array
  {
    ...
    icon: "💯",
    category: BADGE_CATEGORIES.STREAK,
    unlock: (stats) => stats.currentStreak && stats.currentStreak >= 100,
    progress: (stats) => (Math.min(stats.currentStreak || 0, 100) / 100) * 100,
    tier: 4,
  },
  {
    id: "course-25",
    ...
    icon: "📚📚📚",
    category: BADGE_CATEGORIES.COURSE,
    unlock: (stats) => stats.coursesCompleted && stats.coursesCompleted >= 25,
    progress: (stats) => (Math.min(stats.coursesCompleted || 0, 25) / 25) * 100,
    tier: 4,
  },
  {
    id: "xp-10000",
    ...
    icon: "👑",
    category: BADGE_CATEGORIES.XP,
    unlock: (stats) => stats.totalXp && stats.totalXp >= 10000,
    progress: (stats) => (Math.min(stats.totalXp || 0, 10000) / 10000) * 100,
    tier: 4,
  },
  {
    id: "monthly-top10",
  ...
  },
  {
    ...
    icon: "⚡",
    category: BADGE_CATEGORIES.SPECIAL,
    unlock: (stats) => stats.fastCourseCompletions && stats.fastCourseCompletions >= 1,
    progress: (stats) => (stats.fastCourseCompletions && stats.fastCourseCompletions >= 1 ? 100 : 0),
    tier: 2,
  },
  {
    id: "polyglot",
    ...
    icon: "🌎",
    category: BADGE_CATEGORIES.SPECIAL,
    unlock: (stats) => stats.languagesLearned && stats.languagesLearned >= 3,
    progress: (stats) => (Math.min(stats.languagesLearned || 0, 3) / 3) * 100,
    tier: 2,
  },
  {
    id: "quiz-5",
    ...
    icon: "🏅",
    category: BADGE_CATEGORIES.QUIZ,
    unlock: (stats) => stats.perfectQuizzes && stats.perfectQuizzes >= 5,
    progress: (stats) => (Math.min(stats.perfectQuizzes || 0, 5) / 5) * 100,
    tier: 3,
  },
  // {
  ...
  // },
  {
    ...
    icon: "🎮",
    category: BADGE_CATEGORIES.SPECIAL,
    unlock: (stats) => stats.weekendLessons && stats.weekendLessons >= 10,
    progress: (stats) => (Math.min(stats.weekendLessons || 0, 10) / 10) * 100,
    tier: 1,
  },
  {
    id: "mobile-learner",
    ...
    icon: "📱",
    category: BADGE_CATEGORIES.SPECIAL,
    unlock: (stats) => stats.mobileLessons && stats.mobileLessons >= 10,
    progress: (stats) => (Math.min(stats.mobileLessons || 0, 10) / 10) * 100,
    tier: 1,
  },
  // {
  ...
  // },
  {
    ...
    icon: "📖",
    category: BADGE_CATEGORIES.SPECIAL,
    unlock: (stats) => stats.totalLearningHours  && stats.totalLearningHours >= 50,
    progress: (stats) => (Math.min(stats.totalLearningHours || 0, 50) / 50) * 100,
    tier: 2,
  },
  // {
  //   id: "marathoner",
